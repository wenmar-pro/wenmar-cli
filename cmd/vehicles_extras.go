...
func init() {
	...
	_ = vehiclesCreateCmd.MarkFlagRequired("make")
	_ = vehiclesCreateCmd.MarkFlagRequired("model")
	_ = vehiclesCreateCmd.MarkFlagRequired("year")
	_ = vehiclesCreateCmd.MarkFlagRequired("customer-id")
